...
class TutorialHelper:
    ...
    def check_fideo_form(self):
        ...
        try:
            time.sleep(2)
            wd.find_element_by_xpath('//*[@id="LandingPageContainer"]/section/div/div[1]/div[2]')
...
# Ignite, Chapter 1 - How to Get Started With SmartTrader
    ...
    def chapter1_video2(self):
        ...
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[1]/div/div[1]/div/div[2]/h5/a')
        if name:
    ...
    def chapter1_video3(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[1]/div/div[1]/div/div[3]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[1]/div/div[1]/div/div[3]/h5/a')
            return name1.text
    ...
    def chapter1_video3_3(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[1]/div/div[1]/div/div[3]/h5/a').click()

    def chapter1_video4(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[1]/div/div[1]/div/div[4]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[1]/div/div[1]/div/div[4]/h5/a')
            return name1.text
...
# Ignite, Chapter 2 - Understanding Toolbars and How to Customize Them
    def chapter2_video1(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[1]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[1]/h5/a')
            return name1.text
    ...
    def chapter2_video1_1(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[1]/h5/a').click()

    def chapter2_video2(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[2]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[2]/h5/a')
            return name1.text
    ...
    def chapter2_video2_2(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[2]/h5/a').click()

    def chapter2_video3(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[3]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[3]/h5/a')
            return name1.text
    ...
    def chapter2_video3_3(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[3]/h5/a').click()

    def chapter2_video4(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[4]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[4]/h5/a')
            return name1.text
    ...
    def chapter2_video4_4(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[4]/h5/a').click()
    ...
    def chapter2_video5(self):
        ...
        self.click_swiper_2()
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[5]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[5]/h5/a')
            return name1.text
    ...
    def chapter2_video5_5(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[5]/h5/a').click()
    ...
    def chapter2_video6(self):
        ...
        self.click_swiper_2()
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[6]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[6]/h5/a')
            return name1.text
    ...
    def chapter2_video6_6(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[6]/h5/a').click()
    ...
    def chapter2_video7(self):
        ...
        self.click_swiper_2()
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[7]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[2]/div/div[1]/div/div[7]/h5/a')
            return name1.text
...
# Ignite, Chapter 3 - Understanding Indicators, Templates, and Tracking
    def chapter3_video1(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[1]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[1]/h5/a')
            return name1.text
    ...
    def chapter3_video1_1(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[1]/h5/a').click()

    def chapter3_video2(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[2]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[2]/h5/a')
            return name1.text
    ...
    def chapter3_video2_2(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[2]/h5/a').click()

    def chapter3_video3(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[3]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[3]/h5/a')
            return name1.text
    ...
    def chapter3_video3_3(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[3]/h5/a').click()

    def chapter3_video4(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[4]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[3]/div/div[1]/div/div[4]/h5/a')
            return name1.text
...
# Ignite, Chapter 4 - How to Use SmartTrader Alerts With Trading
    def chapter4_video1(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[4]/div/div[1]/div/div[1]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[4]/div/div[1]/div/div[1]/h5/a')
            return name1.text
    ...
    def chapter4_video1_1(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[4]/div/div[1]/div/div[1]/h5/a').click()
    ...
    def chapter4_video2_2(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[4]/div/div[1]/div/div[2]/h5/a').click()

    def chapter4_video3(self):
        wd = self.app.wd
        name = wd.find_elements_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[4]/div/div[1]/div/div[3]/h5/a')
        if name:
            name1 = wd.find_element_by_xpath(
                '//*[@id="LandingPageContainer"]/section/section[2]/div/section[4]/div/div[1]/div/div[3]/h5/a')
            return name1.text
    ...
    def chapter4_video3_3(self):
        wd = self.app.wd
        wd.find_element_by_xpath(
            '//*[@id="LandingPageContainer"]/section/section[2]/div/section[4]/div/div[1]/div/div[3]/h5/a').click()

...
class TutorialHelper:
    ...
    def open_tutorial(self):
        ...
        element = wd.find_element(By.CSS_SELECTOR, '.firstNavColumn.secondPart')
        element.find_element(By.LINK_TEXT, 'Tutorials').click()
        time.sleep(1)

    def check_video_form(self):
        wd = self.app.wd
        try:
            time.sleep(2)
            wd.find_element(By.XPATH, '//*[@id="__layout"]/div/section/div/div[1]/div[2]')
        except InvalidSelectorException as ex:
            print(ex)

    def copy_name_tutorial(self):
        wd = self.app.wd
        name = wd.find_element(By.XPATH, '//*[@id="__layout"]/div/section/div/div[1]/div[3]/h1')
        return name.text

    # Ignite, Chapter 1 - How to Get Started With SmartTrader
    def chapter1_video1(self):
        wd = self.app.wd
        name = wd.find_elements(By.XPATH, '//*[@id="__layout"]'
                                          '/div/section/section[2]/div/section[1]/div/div[1]/div/div[1]/h5/a')
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[1]/div/div[1]/div/div[1]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter1_video2(self):
        wd = self.app.wd
        name = wd.find_elements(By.XPATH,
                                '//*[@id="__layout"]/div/section/section[2]/div/section[1]/div/div[1]/div/div[2]/h5/a')
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[1]/div/div[1]/div/div[2]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter1_video3(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[1]/div/div[1]/div/div[3]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter1_video4(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[1]/div/div[1]/div/div[4]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter2_video1(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[2]/div/div[1]/div/div[1]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter2_video2(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[2]/div/div[1]/div/div[2]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter2_video3(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[2]/div/div[1]/div/div[3]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter2_video4(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[2]/div/div[1]/div/div[4]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def click_swiper_2(self):
        wd = self.app.wd
        wd.find_element(By.XPATH, '//*[@id="__layout"]/div/section/section[2]/div/section[2]/div/div[3]').click()
        time.sleep(2)
    ...
    def chapter2_video5(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[2]/div/div[1]/div/div[5]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter2_video6(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[2]/div/div[1]/div/div[6]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter2_video7(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[2]/div/div[1]/div/div[7]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter3_video1(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[3]/div/div[1]/div/div[1]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter3_video2(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH,  '//*[@id="__layout"]'
                                               '/div/section/section[2]/div/section[3]/div/div[1]/div/div[2]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter3_video3(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[3]/div/div[1]/div/div[3]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter3_video4(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[3]/div/div[1]/div/div[4]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter4_video1(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[4]/div/div[1]/div/div[1]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def chapter4_video2(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH,  '//*[@id="__layout"]'
                                               '/div/section/section[2]/div/section[4]/div/div[1]/div/div[2]/h5/a')
    ...
    def chapter4_video3(self):
        ...
        if name:
            name1 = wd.find_element(By.XPATH, '//*[@id="__layout"]'
                                              '/div/section/section[2]/div/section[4]/div/div[1]/div/div[3]/h5/a')
            return name1.text
        else:
            return print('error')
    ...
    def click_swiper_4(self):
        wd = self.app.wd
        wd.find_element(By.XPATH, '//*[@id="__layout"]/div/section/section[2]/div/section[4]/div/div[3]').click()
        time.sleep(2)
